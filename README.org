...
| dwim-shell-commands-extract-first-video-frame                | Extract first frame from video(s).                                        |
...
| dwim-shell-commands-git-clone-clipboard-url                  | Clone git URL in clipboard to a directory.                                |
...
| dwim-shell-commands-macos-toggle-menu-bar-autohide           | Toggle macOS dark mode.                                                   |
...
| dwim-shell-commands-set-song-title                           | Set song(s) title.                                                        |
| dwim-shell-commands-set-video-framerate                      | Set framerate for marked video(s).                                        |
...
| dwim-shell-commands-upload-to-tmpfiles-org                   | Upload the marked files to 0x0.st                                         |
...
| dwim-shell-commands-video-to-mov                             | Convert all marked videos to mov(s).                                      |
